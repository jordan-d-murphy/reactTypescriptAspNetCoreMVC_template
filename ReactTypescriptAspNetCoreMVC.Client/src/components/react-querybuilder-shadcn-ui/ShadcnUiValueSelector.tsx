...
export type ShadcnUiValueSelectorProps = VersatileSelectorProps & ComponentPropsWithoutRef<typeof Select>;
...
export const ShadcnUiValueSelector = ({
  ...
  return _multiple ? (
    <MultiSelect options={options} value={[value ?? toString()]} onValueChange={handleOnChange} />
  ) : (
